...
local mappings = {
    p = {
        r = { common.execute_on_toggleterm("dotnet run"), "Run project" },
        b = { common.execute_on_toggleterm("dotnet build"), "Build project" },
        w = { common.execute_on_toggleterm("dotnet watch run"), "Watch project" },
    },
}
