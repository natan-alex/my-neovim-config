" settings inspired in https://github.com/jdhao/nvim-config
...
set noruler  " do not show cursor position separated by ,

set nohlsearch incsearch  " do not keep search results highlighted
...
let g:directory=expand(stdpath('data') . '/swap//')
