    ...
    config = function()
        ...
        nvim_tree.setup({
            ...
            on_attach = function(buffer)
                ...
                local mapping_options = { noremap = true, silent = true, nowait = true, buffer = buffer }
                ...
                map("n", "<C-e>", api.node.open.replace_tree_buffer, mapping_options,
                    create_description("Open: In Place"))
                ...
                map("n", "B", api.tree.toggle_no_buffer_filter, mapping_options,
                    create_description("Toggle Filter: No Buffer"))
                map("n", "c", api.fs.copy.node, mapping_options, create_description("Copy"))
                map("n", "C", api.tree.toggle_git_clean_filter, mapping_options,
                    create_description("Toggle Filter: Git Clean"))
                ...
                map("n", "H", api.tree.toggle_hidden_filter, mapping_options,
                    create_description("Toggle Filter: Dotfiles"))
                map("n", "I", api.tree.toggle_gitignore_filter, mapping_options,
                    create_description("Toggle Filter: Git Ignore"))
                ...
                map("n", "O", api.node.open.no_window_picker, mapping_options,
                    create_description("Open: No Window Picker"))
